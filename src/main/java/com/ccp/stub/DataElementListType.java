...
/**
 * <p>Java class for DataElementListType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DataElement" type="{http://messagepoint.com/api/schemas}DataElementType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "DataElementListType", propOrder = {
    "dataElement"
})
public class DataElementListType {
    ...
    public List<DataElementType> getDataElement() {
        if (dataElement == null) {
            dataElement = new ArrayList<DataElementType>();
        }
